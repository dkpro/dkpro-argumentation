 ...
 * <code>de.tudarmstadt.ukp.dkpro.argumentation.tutorial.ArgumentationCorpusDebugger</code>
 * </a> because the Maven package structure for getting that class is very bad.
 *
 * @author <a href="mailto:shore@ukp.informatik.tu-darmstadt.de">Todd Shore</a>
 * @since Apr 28, 2016
 *
 */
public final class XmiFilePatternJsonStreamDumper implements Callable<Void> {
	...
	public XmiFilePatternJsonStreamDumper(final Class<? extends AnalysisComponent> analysisComponentClass,
	...
	@Override
	public Void call() throws UIMAException, IOException {
		final String includePattern = ResourceCollectionReaderBase.INCLUDE_PREFIX + "*.xmi";
		final CollectionReaderDescription xmiReaderDesc = CollectionReaderFactory.createReaderDescription(
				XmiReader.class, ResourceCollectionReaderBase.PARAM_SOURCE_LOCATION, sourceLocation,
				ResourceCollectionReaderBase.PARAM_PATTERNS, includePattern, XmiReader.PARAM_LENIENT, false);
		final AnalysisEngineDescription argumentDumpEngineDesc = AnalysisEngineFactory.createEngineDescription(
				analysisComponentClass, JsonStreamDumpWriter.PARAM_OUTPUT_FILE, targetLocation);
