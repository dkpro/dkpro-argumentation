...
/**
 * A combined {@link List} and {@link Set} implementation which decorates a
 * {@link List} instance, maintaining a {@link Object2IntMap} which has the list
 * elements {@code E} as keys which are mapped to {@link IntSortedSet} objects
 * containing the indices at which each element occurs in the decorated
 * {@code List}.
 *
 * @param <E>
...
public final class ReverseLookupOrderedSet<E> implements List<E>, Serializable, Set<E> {
	...
	public void add(final int index, final E element) {
		...
		Object2IntMapValueArithmetic.incrementValues(reverseLookupMap, shiftedElements, 1, index, lastIndex);
	...
	public boolean addAll(final Collection<? extends E> c) {
		...
		if (result) {
			...
			Object2IntMapValueArithmetic.putIncrementingValues(reverseLookupMap, addedElements, lowestNewIndex);
		}
	...
	public boolean addAll(final int index, final Collection<? extends E> c) {
		...
		if (result) {
			...
			Object2IntMapValueArithmetic.incrementValues(reverseLookupMap, shiftedElements, addedElementCount, index,
